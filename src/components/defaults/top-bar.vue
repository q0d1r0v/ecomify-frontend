    ...
    <div>
        <div class="desktop">
            ...
            <div class="right flex items-center justify-end py-4">
                <div class="border border-[#111CEF] rounded-xl overflow-hidden flex items-center justify-center px-2 py-1 gap-2  cursor-pointer select-none"
                    v-if="locale !== 'uz'" @click="changeLang(locale)">
                ...
                <div class="border border-[#111CEF] rounded-xl overflow-hidden flex items-center justify-center px-2 py-1 gap-2 cursor-pointer select-none"
                    v-else @click="changeLang(locale)">
